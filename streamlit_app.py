...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8, tab9, tab10 = st.tabs(["🏠 Main Calculator", "📈 Sensitivity Analysis", "📖 Paper Explanation", "🔧 Additional Tools", "💰 Points Analysis", "📊 ENPV Analysis", "🏠 Buy Points Analysis", "Net Benefit Timeline", "Value Matching Debug", "Rent v Buy"])
with st.sidebar:
